...
(function () {
    ...
    timezoneJS.timezone = new function () {
        ...
        function parseTimeString(str) {
            ...
            var TemplateProject = str.match(pat);
            TemplateProject[1] = parseInt(TemplateProject[1], 10);
            TemplateProject[2] = TemplateProject[2] ? parseInt(TemplateProject[2], 10) : 0;
            TemplateProject[3] = TemplateProject[3] ? parseInt(TemplateProject[3], 10) : 0;
        ...
        function getRule(dt, zone, isUTC) {
            ...
            var convertRuleToExactDateAndTime = function (yearAndRule, prevRule) {
                ...
                if (EXACT_DATE_TIME[year][rule])
                    ...
                    if (!isNaN(rule[4])) {
                        effectiveDate = new Date(Date.UTC(year, SHORT_MONTHS[rule[3]], rule[4], TemplateProject[1], TemplateProject[2], TemplateProject[3], 0));
                    }
                    //Let's hunt for the date.
                        ...
                        if (rule[4].substr(0, 4) === "last") {
                            ...
                            effectiveDate = new Date(Date.UTC(year, SHORT_MONTHS[rule[3]] + 1, 1, TemplateProject[1] - 24, TemplateProject[2], TemplateProject[3], 0));
                        ...
                        //Example: `Sun>=15`
                            ...
                            effectiveDate = new Date(Date.UTC(year, SHORT_MONTHS[rule[3]], rule[4].substr(5), TemplateProject[1], TemplateProject[2], TemplateProject[3], 0));
                ...
                if (prevRule) {
                    effectiveDate = convertDateToUTC(effectiveDate, TemplateProject[4], prevRule);
                }
