        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeviceInfo = table.Column<string>(maxLength: 450, nullable: true),
                    IpAddress = table.Column<string>(maxLength: 45, nullable: true),
                    LoginDateTime = table.Column<DateTime>(nullable: false),
                    MacAddress = table.Column<string>(maxLength: 40, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_LoginHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LoginHistories_AspNetUsers_ApplicationUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LoginHistories_ApplicationUserId",
